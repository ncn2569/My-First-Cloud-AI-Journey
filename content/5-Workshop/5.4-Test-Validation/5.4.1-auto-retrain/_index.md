...
- Go to S3 Console  => Buckets  => telco-churn-mlops-fcaj  =>
raw/ -> Upload.
...
- Open AWS Lambda  => select function TelcoChurnDriftChecker  => select Monitor tab  => View CloudWatch logs.
...
- Access Amazon SageMaker  => select Pipelines  => select TelcoChurnPipeline.
...
- Access Amazon SageMaker  => select Model Registry  => TelcoChurnModelGroup.
...
- Access Amazon SageMaker  => Endpoints  => telco-churn-serverless-endpoint:
