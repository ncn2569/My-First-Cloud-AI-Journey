...
- Kiểm thử Luồng Dự đoán Thời gian thực (Real-time Inference Flow): Gửi HTTP POST Request từ Client qua API Gateway để kiểm tra khả năng xử lý và trả về kết quả Churn Prediction.
