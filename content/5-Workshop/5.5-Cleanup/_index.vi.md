...
![clean-api](/images/5-Workshop/5.4-Test-Validation/clean-api.png)
...
![clean-lambda](/images/5-Workshop/5.4-Test-Validation/clean-lambda.png)
...
- Bấm Delete.
![clean-event](/images/5-Workshop/5.4-Test-Validation/clean-event.png)

##### Xóa SNS Topic
- Truy cập Amazon SNS  => Topics.
- Chọn Topic TelcoChurnAlerts  => Bấm Delete.
![clean-sns](/images/5-Workshop/5.4-Test-Validation/clean-sns.png)
- Vào mục Subscriptions  => Xóa Subscription liên kết với email của bạn.
![clean-email](/images/5-Workshop/5.4-Test-Validation/clean-email.png)
...
![empty-s3](/images/5-Workshop/5.4-Test-Validation/empty-s3.png)
- Sau khi làm rỗng, chọn lại Bucket đó và bấm Delete để xóa Bucket khỏi hệ thống.
![delete-s3](/images/5-Workshop/5.4-Test-Validation/delete-s3.png)
